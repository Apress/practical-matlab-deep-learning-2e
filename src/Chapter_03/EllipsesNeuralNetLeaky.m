%% Implement and test a leaky neural net to classify circles from ellipses
%% See also:
% GenerateEllipses, categorical, leakyReluLayer, convolution2dLayer,
% batchNormalizationLayer, maxPooling2dLayer, fullyConnectedLayer,
