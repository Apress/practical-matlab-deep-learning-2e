...
% Requires the Image Processing Toolbox. Loads the saved files
% TerrainNet.mat and Loc.mat.
%
% See also RHSPointMassAircraft, TerrainCamera, NewFigure, classify,
% RungeKutta, TimeLabel, PlotSet, PlotXYTrajectory
